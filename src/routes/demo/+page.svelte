...
<!-- prettier-ignore -->
<button on:click={async () => DiscussionPoll.castVote($wiki, {}, { answerIds: '17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,17976834,', pollId: '4651335' })}>
	Click to post
</button>
